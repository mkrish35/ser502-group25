...
public class MintLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"MINT_IF", "MINT_ELSE", "MINT_ELSEIF", "MINT_FOR", "MINT_WHILE", "MINT_BREAK", 
			"MINT_CONTINUE", "SAY", "SAYLN", "T_IF", "T_ELSE", "AND", "OR", "NOT", 
			"ADD", "SUB", "MUL", "DIV", "MOD", "EQ", "NEQ", "LT", "LTE", "GT", "GTE", 
			"ASSIGN", "SEMI", "COMMA", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "INT_TYPE", 
			"FLOAT_TYPE", "STRING_TYPE", "BOOL_TYPE", "NUMBER", "BOOL", "STRING", 
